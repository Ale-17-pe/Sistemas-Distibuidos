...
import com.apiweb.aresfitnes.Model.Ejercicio;
...
public class EjerciciosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        InputStream is = getServletContext().getResourceAsStream("/data/ejercicios.json");
        InputStreamReader reader = new InputStreamReader(is, "UTF-8");

        Gson gson = new Gson();
        List<Ejercicio> ejercicios = gson.fromJson(reader, new TypeToken<List<Ejercicio>>() {}.getType());
